...
from quovadis_tad.dataset_utils.data_utils import preprocess_data, preprocess_data_3D, concatenate_windows_feat, normalise_scores
...
def evaluate_methods_on_dataset_or_traces(
    ...
    if data3D:
        ...
        test=np.array(test)
        train, _, test = preprocess_data_3D(
            train,
            test,
            train_size=0.98,
            val_size=0.02,
    ...
    elif series_are_split_in_traces:
        df = []
